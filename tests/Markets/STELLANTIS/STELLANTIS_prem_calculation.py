...
INPUT_FOLDER  = Path("tests/Markets/STELLANTIS/input_data/")   # dossier des .csv
OUTPUT_FOLDER = Path("tests/Markets/STELLANTIS/premium_risk_charts/")     # sous-dossier d’export
